  ...
  return (
    ...
    >
      <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2' >
        <div className='flex flex-wrap gap-2 shadow-lg bg-white px-3 py-2 rounded-3xl '>
          ...
          <button onClick={() => setColor("gold")} className='outline-none px-4 py-1 rounded-full text-black shadow-lg'
